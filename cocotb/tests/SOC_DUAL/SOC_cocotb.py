...
async def test_dhrystone(dut):
    ...
    #SOC = SOC_TB(dut, binary="/home/hakam/Repos/ChaosCore/binaries/bin/matmul.bin")     # construct TB
...
async def test_bubble_sort(dut):
    ...
    # Bring up TB
    SOC = SOC_TB(dut, binary=["/home/hakam/Repos/ChaosCore/binaries/bin/bubble_sort0.bin", "/home/hakam/Repos/ChaosCore/binaries/bin/addi.bin"])
