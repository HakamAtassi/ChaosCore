...
verilog_file_path = os.path.join(current_file_dir, "../../../../hw/verilog/Frontend/PC_arbit.v") # Target simulation file (Update me!)

module = "PC_arbit"  # Update me!
