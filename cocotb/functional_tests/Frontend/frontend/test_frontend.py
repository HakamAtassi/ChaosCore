...
verilog_file_path = os.path.join(current_file_dir, "../../../../hw/verilog/Frontend/frontend.v")
...
def test_reset():
    configs["module"] = "frontend_cocotb"    # Cocotb file
    configs["toplevel"] = "frontend"         # Verilog top leve module
...
def test_cache():
    configs["module"] = "frontend_cocotb"    # Cocotb file
    configs["toplevel"] = "frontend"         # Verilog top leve module
    configs["testcase"] = "cache"       # Name of your cocotb function
    run(**configs)
...
def test_PC_increment():
    configs["module"] = "frontend_cocotb"    # Cocotb file
    configs["toplevel"] = "frontend"         # Verilog top leve module
    configs["testcase"] = "test_PC_increment"       # Name of your cocotb function
    run(**configs)
...
def test_PC_queue():
    configs["module"] = "frontend_cocotb"    # Cocotb file
    configs["toplevel"] = "frontend"         # Verilog top leve module
    configs["testcase"] = "test_PC_queue"       # Name of your cocotb function
    run(**configs)
