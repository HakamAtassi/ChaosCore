...
do
    ...
    # Compile the C file to ELF using the linker script
    ${rvdir}/riscv32-unknown-elf-gcc -march=rv32im_zicsr -nostartfiles  -std=gnu99 startup0.S "C/$name/$name.c"  -O2 -ffreestanding -Wl,-Bstatic -o "elf/$name.elf"  -T $linker_script -Wextra -Wshadow -Wundef -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Wredundant-decls -Wpedantic -Wcast-qual -g -pedantic  -ffreestanding 
