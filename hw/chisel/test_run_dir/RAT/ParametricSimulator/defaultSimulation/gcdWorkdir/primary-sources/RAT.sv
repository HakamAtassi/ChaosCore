...
module RAT(	// src/main/scala/Frontend/rename.scala:76:7
  ...
  output       io_checkpoints_full,	// src/main/scala/Frontend/rename.scala:83:16
               io_checkpoints_empty,	// src/main/scala/Frontend/rename.scala:83:16
  output [6:0] io_RAT_RD_0,	// src/main/scala/Frontend/rename.scala:83:16
               io_RAT_RD_1,	// src/main/scala/Frontend/rename.scala:83:16
               io_RAT_RD_2,	// src/main/scala/Frontend/rename.scala:83:16
               io_RAT_RD_3,	// src/main/scala/Frontend/rename.scala:83:16
               io_RAT_RS1_0,	// src/main/scala/Frontend/rename.scala:83:16
  ...
  reg  [6:0] io_RAT_RD_0_REG;	// src/main/scala/Frontend/rename.scala:157:33
  ...
  reg  [6:0] io_RAT_RD_1_REG;	// src/main/scala/Frontend/rename.scala:157:33
  ...
  reg  [6:0] io_RAT_RD_2_REG;	// src/main/scala/Frontend/rename.scala:157:33
  ...
  reg  [6:0] io_RAT_RD_3_REG;	// src/main/scala/Frontend/rename.scala:157:33
  ...
  wire       io_checkpoints_empty_0 =
    RAT_front_pointer == RAT_back_pointer & ~io_checkpoints_full_0;	// src/main/scala/Frontend/rename.scala:121:38, :122:38, :139:34, :193:81, :194:{55,77}
  always @(posedge clock) begin	// src/main/scala/Frontend/rename.scala:76:7
    ...
    automatic logic [31:0][6:0] _GEN_221;	// src/main/scala/Frontend/rename.scala:157:33
    _GEN_157 =
      {{RAT_memories_15_0},
       {RAT_memories_14_0},
       {RAT_memories_13_0},
    ...
    _GEN_221 =
      {{_GEN_220},
       ...
       {_GEN_162},
       {_GEN_160},
       {_GEN_158}};	// src/main/scala/Frontend/rename.scala:157:33
    if (reset) begin	// src/main/scala/Frontend/rename.scala:76:7
      ...
      if (io_free_checkpoint & ~io_checkpoints_empty_0)	// src/main/scala/Frontend/rename.scala:145:{29,32}, :194:77
        RAT_back_pointer <= RAT_back_pointer + 5'h1;	// src/main/scala/Frontend/rename.scala:122:38, :146:46
    end
    io_RAT_RD_0_REG <= _GEN_221[io_instruction_RD_0];	// src/main/scala/Frontend/rename.scala:157:33
    io_RAT_RS1_0_REG <= _GEN_221[io_instruction_RS1_0];	// src/main/scala/Frontend/rename.scala:157:33, :158:33
    io_RAT_RS2_0_REG <= _GEN_221[io_instruction_RS2_0];	// src/main/scala/Frontend/rename.scala:157:33, :159:33
    io_RAT_RD_1_REG <= _GEN_221[io_instruction_RD_1];	// src/main/scala/Frontend/rename.scala:157:33
    io_RAT_RS1_1_REG <= _GEN_221[io_instruction_RS1_1];	// src/main/scala/Frontend/rename.scala:157:33, :158:33
    io_RAT_RS2_1_REG <= _GEN_221[io_instruction_RS2_1];	// src/main/scala/Frontend/rename.scala:157:33, :159:33
    io_RAT_RD_2_REG <= _GEN_221[io_instruction_RD_2];	// src/main/scala/Frontend/rename.scala:157:33
    io_RAT_RS1_2_REG <= _GEN_221[io_instruction_RS1_2];	// src/main/scala/Frontend/rename.scala:157:33, :158:33
    io_RAT_RS2_2_REG <= _GEN_221[io_instruction_RS2_2];	// src/main/scala/Frontend/rename.scala:157:33, :159:33
    io_RAT_RD_3_REG <= _GEN_221[io_instruction_RD_3];	// src/main/scala/Frontend/rename.scala:157:33
    io_RAT_RS1_3_REG <= _GEN_221[io_instruction_RS1_3];	// src/main/scala/Frontend/rename.scala:157:33, :158:33
    io_RAT_RS2_3_REG <= _GEN_221[io_instruction_RS2_3];	// src/main/scala/Frontend/rename.scala:157:33, :159:33
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/Frontend/rename.scala:76:7
    ...
    initial begin	// src/main/scala/Frontend/rename.scala:76:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/Frontend/rename.scala:76:7
        ...
        io_RAT_RD_0_REG = _RANDOM[7'h72][16:10];	// src/main/scala/Frontend/rename.scala:76:7, :157:33
        io_RAT_RS1_0_REG = _RANDOM[7'h72][23:17];	// src/main/scala/Frontend/rename.scala:76:7, :157:33, :158:33
        io_RAT_RS2_0_REG = _RANDOM[7'h72][30:24];	// src/main/scala/Frontend/rename.scala:76:7, :157:33, :159:33
        io_RAT_RD_1_REG = {_RANDOM[7'h72][31], _RANDOM[7'h73][5:0]};	// src/main/scala/Frontend/rename.scala:76:7, :157:33
        io_RAT_RS1_1_REG = _RANDOM[7'h73][12:6];	// src/main/scala/Frontend/rename.scala:76:7, :157:33, :158:33
        io_RAT_RS2_1_REG = _RANDOM[7'h73][19:13];	// src/main/scala/Frontend/rename.scala:76:7, :157:33, :159:33
        io_RAT_RD_2_REG = _RANDOM[7'h73][26:20];	// src/main/scala/Frontend/rename.scala:76:7, :157:33
        io_RAT_RS1_2_REG = {_RANDOM[7'h73][31:27], _RANDOM[7'h74][1:0]};	// src/main/scala/Frontend/rename.scala:76:7, :157:33, :158:33
        io_RAT_RS2_2_REG = _RANDOM[7'h74][8:2];	// src/main/scala/Frontend/rename.scala:76:7, :158:33, :159:33
        io_RAT_RD_3_REG = _RANDOM[7'h74][15:9];	// src/main/scala/Frontend/rename.scala:76:7, :157:33, :158:33
  ...
  assign io_checkpoints_empty = io_checkpoints_empty_0;	// src/main/scala/Frontend/rename.scala:76:7, :194:77
  assign io_RAT_RD_0 = io_RAT_RD_0_REG;	// src/main/scala/Frontend/rename.scala:76:7, :157:33
  assign io_RAT_RD_1 = io_RAT_RD_1_REG;	// src/main/scala/Frontend/rename.scala:76:7, :157:33
  assign io_RAT_RD_2 = io_RAT_RD_2_REG;	// src/main/scala/Frontend/rename.scala:76:7, :157:33
  assign io_RAT_RD_3 = io_RAT_RD_3_REG;	// src/main/scala/Frontend/rename.scala:76:7, :157:33
