...
module predecoder(
  ...
  wire        is_taken =
    curr_is_BRANCH & _is_BTB_taken_T_9 & io_prediction_bits.T_NT | curr_is_JALR
    | curr_is_JAL;
  ...
  wire        is_taken_1 =
    curr_is_BRANCH_1 & _is_BTB_taken_T_9 & io_prediction_bits.T_NT | curr_is_JALR_1
    | curr_is_JAL_1;
  ...
  wire        is_taken_2 =
    curr_is_BRANCH_2 & _is_BTB_taken_T_9 & io_prediction_bits.T_NT | curr_is_JALR_2
    | curr_is_JAL_2;
  ...
  wire        is_taken_3 =
    curr_is_BRANCH_3 & _is_BTB_taken_T_9 & io_prediction_bits.T_NT | curr_is_JALR_3
    | curr_is_JAL_3;
  ...
  assign T_NT =
    ...
    & {4{io_prediction_bits.T_NT}} | _GEN_4 | _GEN_5;
  assign is_JAL =
    is_taken_3
      ? curr_is_JAL_3
