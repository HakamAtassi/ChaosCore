...
module mem_64x17(	// src/main/scala/memories/memories.scala:310:24
  input  [5:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [16:0] R0_data,
  ...
  reg [16:0] Memory[0:63];	// src/main/scala/memories/memories.scala:310:24
    ...
    initial begin	// src/main/scala/memories/memories.scala:310:24
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/memories/memories.scala:310:24
        for (logic [6:0] i = 7'h0; i < 7'h40; i += 7'h1) begin
          ...
          Memory[i[5:0]] = _RANDOM_MEM[16:0];	// src/main/scala/memories/memories.scala:310:24
        end
  ...
  assign R0_data = _R0_en_d0 ? Memory[_R0_addr_d0] : 17'bx;	// src/main/scala/memories/memories.scala:310:24
endmodule
