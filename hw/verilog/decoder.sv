...
module decoder(
  ...
  wire [6:0]  _decode_pat_andMatrixOutputs_T_1 =
    {decode_pat_invInputs[0],
     ...
     decode_pat_invInputs[11],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_2 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     decode_pat_invInputs[2],
     decode_pat_invInputs[3],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [8:0]  _decode_pat_andMatrixOutputs_T_3 =
    {io_instruction_bits_instruction[2],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [6:0]  _decode_pat_andMatrixOutputs_T_4 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     decode_pat_invInputs[3],
     ...
     decode_pat_invInputs[10],
     io_instruction_valid};
  wire [12:0] _decode_pat_andMatrixOutputs_T_5 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     decode_pat_invInputs[3],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [5:0]  _decode_pat_andMatrixOutputs_T_6 =
    {io_instruction_bits_instruction[2],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     decode_pat_invInputs[3],
     decode_pat_invInputs[4],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_7 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     decode_pat_invInputs[2],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_8 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     decode_pat_invInputs[2],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [14:0] _decode_pat_andMatrixOutputs_T_9 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [12:0] _decode_pat_andMatrixOutputs_T_10 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [5:0]  _decode_pat_andMatrixOutputs_T_11 =
    {io_instruction_bits_instruction[2],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     decode_pat_invInputs[4],
     io_instruction_valid};
  wire [6:0]  _decode_pat_andMatrixOutputs_T_12 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     decode_pat_invInputs[2],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[11],
     io_instruction_valid};
  wire [8:0]  _decode_pat_andMatrixOutputs_T_13 =
    {io_instruction_bits_instruction[2],
     decode_pat_invInputs[1],
     decode_pat_invInputs[2],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [5:0]  _decode_pat_andMatrixOutputs_T_14 =
    {io_instruction_bits_instruction[2],
     io_instruction_bits_instruction[3],
     decode_pat_invInputs[2],
     io_instruction_bits_instruction[5],
     io_instruction_bits_instruction[6],
     io_instruction_valid};
  wire [30:0] _decode_pat_andMatrixOutputs_T_15 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_16 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [6:0]  _decode_pat_andMatrixOutputs_T_17 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     decode_pat_invInputs[3],
     ...
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_18 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[12],
     io_instruction_valid};
  wire [12:0] _decode_pat_andMatrixOutputs_T_22 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     decode_pat_invInputs[3],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [14:0] _decode_pat_andMatrixOutputs_T_23 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_24 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     io_instruction_bits_instruction[14],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_25 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     decode_pat_invInputs[2],
     io_instruction_bits_instruction[5],
     ...
     io_instruction_bits_instruction[14],
     io_instruction_valid};
  wire [7:0]  _decode_pat_andMatrixOutputs_T_26 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     io_instruction_bits_instruction[14],
     io_instruction_valid};
  wire [12:0] _decode_pat_andMatrixOutputs_T_27 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
     ...
     decode_pat_invInputs[29],
     io_instruction_valid};
  wire [30:0] _decode_pat_andMatrixOutputs_T_29 =
    {decode_pat_invInputs[0],
     decode_pat_invInputs[1],
     io_instruction_bits_instruction[4],
     io_instruction_bits_instruction[5],
  ...
  wire [16:0] decode_pat =
    {|{&_decode_pat_andMatrixOutputs_T_7,
       &_decode_pat_andMatrixOutputs_T_8,
       &_decode_pat_andMatrixOutputs_T_9,
       &_decode_pat_andMatrixOutputs_T_10,
       &_decode_pat_andMatrixOutputs_T_12,
       &_decode_pat_andMatrixOutputs_T_23,
       &_decode_pat_andMatrixOutputs_T_25,
       &_decode_pat_andMatrixOutputs_T_27},
     |{&_decode_pat_andMatrixOutputs_T_1,
       &_decode_pat_andMatrixOutputs_T_2,
       &_decode_pat_andMatrixOutputs_T_4,
       &_decode_pat_andMatrixOutputs_T_5,
       &_decode_pat_andMatrixOutputs_T_7,
       &_decode_pat_andMatrixOutputs_T_8,
       &_decode_pat_andMatrixOutputs_T_9,
       &_decode_pat_andMatrixOutputs_T_10,
       &_decode_pat_andMatrixOutputs_T_12,
       &_decode_pat_andMatrixOutputs_T_13,
       &_decode_pat_andMatrixOutputs_T_16,
       &_decode_pat_andMatrixOutputs_T_17,
     ...
     |{&_decode_pat_andMatrixOutputs_T,
       ...
       &_decode_pat_andMatrixOutputs_T_16,
       &_decode_pat_andMatrixOutputs_T_18,
       &_decode_pat_andMatrixOutputs_T_24,
       &_decode_pat_andMatrixOutputs_T_26,
       &_decode_pat_andMatrixOutputs_T_29},
     |{&_decode_pat_andMatrixOutputs_T_1,
       &_decode_pat_andMatrixOutputs_T_2,
       &_decode_pat_andMatrixOutputs_T_7,
       &_decode_pat_andMatrixOutputs_T_8},
     ...
     &_decode_pat_andMatrixOutputs_T,
     &_decode_pat_andMatrixOutputs_T_15,
     |{&_decode_pat_andMatrixOutputs_T_1, &_decode_pat_andMatrixOutputs_T_2},
     |{&_decode_pat_andMatrixOutputs_T_7, &_decode_pat_andMatrixOutputs_T_8},
     |{&_decode_pat_andMatrixOutputs_T,
       &_decode_pat_andMatrixOutputs_T_3,
       &_decode_pat_andMatrixOutputs_T_15,
       &_decode_pat_andMatrixOutputs_T_29},
