...
module decoder(	// src/main/scala/Frontend/decoder.scala:40:7
  ...
  input  [5:0]  io_instruction_bits_ROB_index,	// src/main/scala/Frontend/decoder.scala:43:16
  ...
  output [5:0]  io_decoded_instruction_bits_ROB_index,	// src/main/scala/Frontend/decoder.scala:43:16
  ...
  output        io_decoded_instruction_bits_needs_ALU,	// src/main/scala/Frontend/decoder.scala:43:16
                ...
                io_decoded_instruction_bits_is_load,	// src/main/scala/Frontend/decoder.scala:43:16
                io_decoded_instruction_bits_is_store	// src/main/scala/Frontend/decoder.scala:43:16
);
  ...
  wire       is_load = instructionType == 5'h0;	// src/main/scala/Frontend/decoder.scala:65:56
  ...
  wire       is_store = instructionType == 5'h8;	// src/main/scala/Frontend/decoder.scala:65:56
  ...
  reg  [1:0] next_ALU_port_0;	// src/main/scala/Frontend/decoder.scala:157:32
  reg  [1:0] next_ALU_port_1;	// src/main/scala/Frontend/decoder.scala:157:32
  reg  [1:0] next_ALU_port_2;	// src/main/scala/Frontend/decoder.scala:157:32
  always @(posedge clock) begin	// src/main/scala/Frontend/decoder.scala:40:7
    if (reset) begin	// src/main/scala/Frontend/decoder.scala:40:7
      next_ALU_port_0 <= 2'h0;	// src/main/scala/Frontend/decoder.scala:157:32
      next_ALU_port_1 <= 2'h1;	// src/main/scala/Frontend/decoder.scala:157:32
      next_ALU_port_2 <= 2'h2;	// src/main/scala/Frontend/decoder.scala:157:32
    end
    else if (needs_ALU) begin	// src/main/scala/Frontend/decoder.scala:87:80, :88:{63,92}
      next_ALU_port_0 <= next_ALU_port_1;	// src/main/scala/Frontend/decoder.scala:157:32
      next_ALU_port_1 <= next_ALU_port_2;	// src/main/scala/Frontend/decoder.scala:157:32
      next_ALU_port_2 <= next_ALU_port_0;	// src/main/scala/Frontend/decoder.scala:157:32
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/Frontend/decoder.scala:40:7
    ...
    initial begin	// src/main/scala/Frontend/decoder.scala:40:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/Frontend/decoder.scala:40:7
        ...
        next_ALU_port_0 = _RANDOM[/*Zero width*/ 1'b0][1:0];	// src/main/scala/Frontend/decoder.scala:40:7, :157:32
        next_ALU_port_1 = _RANDOM[/*Zero width*/ 1'b0][3:2];	// src/main/scala/Frontend/decoder.scala:40:7, :157:32
        next_ALU_port_2 = _RANDOM[/*Zero width*/ 1'b0][5:4];	// src/main/scala/Frontend/decoder.scala:40:7, :157:32
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_decoded_instruction_bits_RD = {2'h0, io_instruction_bits_instruction[11:7]};	// src/main/scala/Frontend/decoder.scala:40:7, :58:34, :130:54
  assign io_decoded_instruction_bits_RD_valid =
    (_is_INT_T | _is_INT_T_1 | is_load | _is_INT_T_5 | _is_INT_T_7 | _is_INT_T_9
     | _is_INT_T_11 | _io_decoded_instruction_bits_RD_valid_T_13) & io_instruction_valid;	// src/main/scala/Frontend/decoder.scala:40:7, :65:56, :107:77, :108:77, :109:77, :110:77, :111:77, :112:77, :113:77, :114:77
  assign io_decoded_instruction_bits_RS1 = {2'h0, io_instruction_bits_instruction[19:15]};	// src/main/scala/Frontend/decoder.scala:40:7, :56:34, :132:54
  assign io_decoded_instruction_bits_RS1_valid =
    (_is_INT_T | _is_INT_T_1 | is_load | is_store | _is_INT_T_7 | _is_INT_T_3)
    & io_instruction_valid;	// src/main/scala/Frontend/decoder.scala:40:7, :65:56, :117:89, :118:89, :119:89, :120:89, :121:89, :122:89
  assign io_decoded_instruction_bits_RS2 = {2'h0, io_instruction_bits_instruction[24:20]};	// src/main/scala/Frontend/decoder.scala:40:7, :57:34, :133:54
  assign io_decoded_instruction_bits_RS2_valid =
    (_is_INT_T | is_store | _is_INT_T_3) & io_instruction_valid;	// src/main/scala/Frontend/decoder.scala:40:7, :65:56, :125:89, :126:89, :127:89
  ...
  assign io_decoded_instruction_bits_packet_index = io_instruction_bits_packet_index[1:0];	// src/main/scala/Frontend/decoder.scala:40:7, :143:54
  assign io_decoded_instruction_bits_ROB_index = io_instruction_bits_ROB_index;	// src/main/scala/Frontend/decoder.scala:40:7
      ...
      : needs_branch_unit
          ...
          : _is_INT_T
            ...
            & io_instruction_bits_instruction[25]
              ? 2'h1
              : {2{is_store | is_load}};	// src/main/scala/Frontend/decoder.scala:40:7, :61:34, :62:34, :65:56, :83:{59,71,81,91,101,111,121,131,142,151}, :84:{63,92}, :87:80, :88:{63,92}, :93:62, :157:32, :159:20, :160:44, :164:34, :165:44, :166:27, :168:30, :169:44, :170:29, :171:44, :173:44
  assign io_decoded_instruction_bits_RS_type =
    _is_INT_T | _is_INT_T_1 | _is_INT_T_3 | _is_INT_T_5 | _is_INT_T_7 | _is_INT_T_9
    | _is_INT_T_11
      ? 2'h0
      : is_load | is_store ? 2'h1 : 2'h2;	// src/main/scala/Frontend/decoder.scala:40:7, :65:56, :179:{47,79,111,140,170,199}, :180:49, :182:17, :183:46, :184:23, :185:46, :187:46
  ...
  assign io_decoded_instruction_bits_is_load = is_load;	// src/main/scala/Frontend/decoder.scala:40:7, :65:56
  assign io_decoded_instruction_bits_is_store = is_store;	// src/main/scala/Frontend/decoder.scala:40:7, :65:56
endmodule
