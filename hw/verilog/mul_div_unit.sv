...
module mul_div_unit(
  ...
  input         io_FU_input_bits_decoded_instruction_MULTIPLY,
    ...
    if (reset)
      ...
      operand2_unsigned =
        io_FU_input_bits_decoded_instruction_IS_IMM
          ? IMM_signed
          : io_FU_input_bits_RS2_data;
      _REMU_T = io_FU_input_bits_decoded_instruction_instructionType == 5'hC;
      _GEN = {32'h0, operand2_unsigned};
      if (_REMU_T & io_FU_input_bits_decoded_instruction_FUNCT3 == 3'h1
          & io_FU_input_bits_decoded_instruction_MULTIPLY | _REMU_T
        ...
        operand2_signed =
          io_FU_input_bits_decoded_instruction_IS_IMM
            ? IMM_signed
            : io_FU_input_bits_RS2_data;
        if (_REMU_T & io_FU_input_bits_decoded_instruction_FUNCT3 == 3'h4
