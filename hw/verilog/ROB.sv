...
module ROB(
  ...
  output [5:0]  io_partial_commit_ROB_index_0_bits,
  output        io_partial_commit_ROB_index_1_valid,
  output [5:0]  io_partial_commit_ROB_index_1_bits,
  output        io_partial_commit_ROB_index_2_valid,
  output [5:0]  io_partial_commit_ROB_index_2_bits,
  output        io_partial_commit_ROB_index_3_valid,
  output [5:0]  io_partial_commit_ROB_index_3_bits,
  output        io_partial_commit_MOB_index_0_valid,
  output [3:0]  io_partial_commit_MOB_index_0_bits,
  output        io_partial_commit_MOB_index_1_valid,
  output [3:0]  io_partial_commit_MOB_index_1_bits,
  output        io_partial_commit_MOB_index_2_valid,
  output [3:0]  io_partial_commit_MOB_index_2_bits,
  output        io_partial_commit_MOB_index_3_valid,
  output [3:0]  io_partial_commit_MOB_index_3_bits,
  ...
  wire [15:0]      commit_resolved_0_GHR =
    _GEN_0 ? 16'h0 : _fetch_resolved_banks_0_ext_R0_data[51:36];
  wire             commit_resolved_0_T_NT =
    _GEN_0 ? commit_resolved_0_REG_T_NT : _fetch_resolved_banks_0_ext_R0_data[52];
  ...
  wire [15:0]      commit_resolved_1_GHR =
    _GEN_1 ? 16'h0 : _fetch_resolved_banks_1_ext_R0_data[51:36];
  wire             commit_resolved_1_T_NT =
    _GEN_1 ? commit_resolved_1_REG_T_NT : _fetch_resolved_banks_1_ext_R0_data[52];
  ...
  wire [15:0]      commit_resolved_2_GHR =
    _GEN_2 ? 16'h0 : _fetch_resolved_banks_2_ext_R0_data[51:36];
  wire             commit_resolved_2_T_NT =
    _GEN_2 ? commit_resolved_2_REG_T_NT : _fetch_resolved_banks_2_ext_R0_data[52];
  ...
  wire [15:0]      commit_resolved_3_GHR =
    _GEN_3 ? 16'h0 : _fetch_resolved_banks_3_ext_R0_data[51:36];
  wire             commit_resolved_3_T_NT =
    _GEN_3 ? commit_resolved_3_REG_T_NT : _fetch_resolved_banks_3_ext_R0_data[52];
  wire [63:0]      _GEN_4 =
    {{row_valid_mem_63},
     {row_valid_mem_62},
     {row_valid_mem_61},
  ...
  wire             commit_row_complete_0 =
    _commit_row_complete_0_T & ROB_output_row_valid;
  wire             _commit_row_complete_1_T =
  ...
  wire             commit_row_complete_1 =
    _commit_row_complete_1_T & ROB_output_row_valid;
  wire             _commit_row_complete_2_T =
  ...
  wire             commit_row_complete_2 =
    _commit_row_complete_2_T & ROB_output_row_valid;
  wire             _commit_row_complete_3_T =
    ROB_output_complete_3 & ROB_output_ROB_entries_3_valid
    | ~ROB_output_ROB_entries_3_valid;
  wire             commit_row_complete_3 =
    _commit_row_complete_3_T & ROB_output_row_valid;
  assign commit_valid =
  ...
  assign io_commit_bits_is_misprediction_0 =
  ...
  always @(posedge clock) begin
    automatic logic _GEN_8 = io_FU_outputs_0_bits_ROB_index == ROB_output_ROB_index;
    if (reset) begin
      front_pointer <= 7'h0;
      back_pointer <= 7'h0;
      ...
      automatic logic _GEN_137 = commit_valid & io_commit_bits_is_misprediction_0;
      if (_GEN_137) begin
        front_pointer <= 7'h0;
        back_pointer <= 7'h0;
      end
      ...
      row_valid_mem_0 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h0 | io_flush | _GEN_73) & _GEN_9
             : ~(io_flush | _GEN_73) & _GEN_9);
      row_valid_mem_1 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1 | io_flush | _GEN_74) & _GEN_10
             : ~(io_flush | _GEN_74) & _GEN_10);
      row_valid_mem_2 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2 | io_flush | _GEN_75) & _GEN_11
             : ~(io_flush | _GEN_75) & _GEN_11);
      row_valid_mem_3 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h3 | io_flush | _GEN_76) & _GEN_12
             : ~(io_flush | _GEN_76) & _GEN_12);
      row_valid_mem_4 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h4 | io_flush | _GEN_77) & _GEN_13
             : ~(io_flush | _GEN_77) & _GEN_13);
      row_valid_mem_5 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h5 | io_flush | _GEN_78) & _GEN_14
             : ~(io_flush | _GEN_78) & _GEN_14);
      row_valid_mem_6 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h6 | io_flush | _GEN_79) & _GEN_15
             : ~(io_flush | _GEN_79) & _GEN_15);
      row_valid_mem_7 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h7 | io_flush | _GEN_80) & _GEN_16
             : ~(io_flush | _GEN_80) & _GEN_16);
      row_valid_mem_8 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h8 | io_flush | _GEN_81) & _GEN_17
             : ~(io_flush | _GEN_81) & _GEN_17);
      row_valid_mem_9 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h9 | io_flush | _GEN_82) & _GEN_18
             : ~(io_flush | _GEN_82) & _GEN_18);
      row_valid_mem_10 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'hA | io_flush | _GEN_83) & _GEN_19
             : ~(io_flush | _GEN_83) & _GEN_19);
      row_valid_mem_11 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'hB | io_flush | _GEN_84) & _GEN_20
             : ~(io_flush | _GEN_84) & _GEN_20);
      row_valid_mem_12 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'hC | io_flush | _GEN_85) & _GEN_21
             : ~(io_flush | _GEN_85) & _GEN_21);
      row_valid_mem_13 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'hD | io_flush | _GEN_86) & _GEN_22
             : ~(io_flush | _GEN_86) & _GEN_22);
      row_valid_mem_14 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'hE | io_flush | _GEN_87) & _GEN_23
             : ~(io_flush | _GEN_87) & _GEN_23);
      row_valid_mem_15 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'hF | io_flush | _GEN_88) & _GEN_24
             : ~(io_flush | _GEN_88) & _GEN_24);
      row_valid_mem_16 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h10 | io_flush | _GEN_89) & _GEN_25
             : ~(io_flush | _GEN_89) & _GEN_25);
      row_valid_mem_17 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h11 | io_flush | _GEN_90) & _GEN_26
             : ~(io_flush | _GEN_90) & _GEN_26);
      row_valid_mem_18 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h12 | io_flush | _GEN_91) & _GEN_27
             : ~(io_flush | _GEN_91) & _GEN_27);
      row_valid_mem_19 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h13 | io_flush | _GEN_92) & _GEN_28
             : ~(io_flush | _GEN_92) & _GEN_28);
      row_valid_mem_20 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h14 | io_flush | _GEN_93) & _GEN_29
             : ~(io_flush | _GEN_93) & _GEN_29);
      row_valid_mem_21 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h15 | io_flush | _GEN_94) & _GEN_30
             : ~(io_flush | _GEN_94) & _GEN_30);
      row_valid_mem_22 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h16 | io_flush | _GEN_95) & _GEN_31
             : ~(io_flush | _GEN_95) & _GEN_31);
      row_valid_mem_23 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h17 | io_flush | _GEN_96) & _GEN_32
             : ~(io_flush | _GEN_96) & _GEN_32);
      row_valid_mem_24 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h18 | io_flush | _GEN_97) & _GEN_33
             : ~(io_flush | _GEN_97) & _GEN_33);
      row_valid_mem_25 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h19 | io_flush | _GEN_98) & _GEN_34
             : ~(io_flush | _GEN_98) & _GEN_34);
      row_valid_mem_26 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1A | io_flush | _GEN_99) & _GEN_35
             : ~(io_flush | _GEN_99) & _GEN_35);
      row_valid_mem_27 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1B | io_flush | _GEN_100) & _GEN_36
             : ~(io_flush | _GEN_100) & _GEN_36);
      row_valid_mem_28 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1C | io_flush | _GEN_101) & _GEN_37
             : ~(io_flush | _GEN_101) & _GEN_37);
      row_valid_mem_29 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1D | io_flush | _GEN_102) & _GEN_38
             : ~(io_flush | _GEN_102) & _GEN_38);
      row_valid_mem_30 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1E | io_flush | _GEN_103) & _GEN_39
             : ~(io_flush | _GEN_103) & _GEN_39);
      row_valid_mem_31 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h1F | io_flush | _GEN_104) & _GEN_40
             : ~(io_flush | _GEN_104) & _GEN_40);
      row_valid_mem_32 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h20 | io_flush | _GEN_105) & _GEN_41
             : ~(io_flush | _GEN_105) & _GEN_41);
      row_valid_mem_33 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h21 | io_flush | _GEN_106) & _GEN_42
             : ~(io_flush | _GEN_106) & _GEN_42);
      row_valid_mem_34 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h22 | io_flush | _GEN_107) & _GEN_43
             : ~(io_flush | _GEN_107) & _GEN_43);
      row_valid_mem_35 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h23 | io_flush | _GEN_108) & _GEN_44
             : ~(io_flush | _GEN_108) & _GEN_44);
      row_valid_mem_36 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h24 | io_flush | _GEN_109) & _GEN_45
             : ~(io_flush | _GEN_109) & _GEN_45);
      row_valid_mem_37 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h25 | io_flush | _GEN_110) & _GEN_46
             : ~(io_flush | _GEN_110) & _GEN_46);
      row_valid_mem_38 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h26 | io_flush | _GEN_111) & _GEN_47
             : ~(io_flush | _GEN_111) & _GEN_47);
      row_valid_mem_39 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h27 | io_flush | _GEN_112) & _GEN_48
             : ~(io_flush | _GEN_112) & _GEN_48);
      row_valid_mem_40 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h28 | io_flush | _GEN_113) & _GEN_49
             : ~(io_flush | _GEN_113) & _GEN_49);
      row_valid_mem_41 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h29 | io_flush | _GEN_114) & _GEN_50
             : ~(io_flush | _GEN_114) & _GEN_50);
      row_valid_mem_42 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2A | io_flush | _GEN_115) & _GEN_51
             : ~(io_flush | _GEN_115) & _GEN_51);
      row_valid_mem_43 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2B | io_flush | _GEN_116) & _GEN_52
             : ~(io_flush | _GEN_116) & _GEN_52);
      row_valid_mem_44 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2C | io_flush | _GEN_117) & _GEN_53
             : ~(io_flush | _GEN_117) & _GEN_53);
      row_valid_mem_45 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2D | io_flush | _GEN_118) & _GEN_54
             : ~(io_flush | _GEN_118) & _GEN_54);
      row_valid_mem_46 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2E | io_flush | _GEN_119) & _GEN_55
             : ~(io_flush | _GEN_119) & _GEN_55);
      row_valid_mem_47 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h2F | io_flush | _GEN_120) & _GEN_56
             : ~(io_flush | _GEN_120) & _GEN_56);
      row_valid_mem_48 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h30 | io_flush | _GEN_121) & _GEN_57
             : ~(io_flush | _GEN_121) & _GEN_57);
      row_valid_mem_49 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h31 | io_flush | _GEN_122) & _GEN_58
             : ~(io_flush | _GEN_122) & _GEN_58);
      row_valid_mem_50 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h32 | io_flush | _GEN_123) & _GEN_59
             : ~(io_flush | _GEN_123) & _GEN_59);
      row_valid_mem_51 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h33 | io_flush | _GEN_124) & _GEN_60
             : ~(io_flush | _GEN_124) & _GEN_60);
      row_valid_mem_52 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h34 | io_flush | _GEN_125) & _GEN_61
             : ~(io_flush | _GEN_125) & _GEN_61);
      row_valid_mem_53 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h35 | io_flush | _GEN_126) & _GEN_62
             : ~(io_flush | _GEN_126) & _GEN_62);
      row_valid_mem_54 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h36 | io_flush | _GEN_127) & _GEN_63
             : ~(io_flush | _GEN_127) & _GEN_63);
      row_valid_mem_55 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h37 | io_flush | _GEN_128) & _GEN_64
             : ~(io_flush | _GEN_128) & _GEN_64);
      row_valid_mem_56 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h38 | io_flush | _GEN_129) & _GEN_65
             : ~(io_flush | _GEN_129) & _GEN_65);
      row_valid_mem_57 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h39 | io_flush | _GEN_130) & _GEN_66
             : ~(io_flush | _GEN_130) & _GEN_66);
      row_valid_mem_58 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h3A | io_flush | _GEN_131) & _GEN_67
             : ~(io_flush | _GEN_131) & _GEN_67);
      row_valid_mem_59 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h3B | io_flush | _GEN_132) & _GEN_68
             : ~(io_flush | _GEN_132) & _GEN_68);
      row_valid_mem_60 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h3C | io_flush | _GEN_133) & _GEN_69
             : ~(io_flush | _GEN_133) & _GEN_69);
      row_valid_mem_61 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h3D | io_flush | _GEN_134) & _GEN_70
             : ~(io_flush | _GEN_134) & _GEN_70);
      row_valid_mem_62 <=
        ~_GEN_137
        & (commit_valid
             ? ~(ROB_output_ROB_index == 6'h3E | io_flush | _GEN_135) & _GEN_71
             : ~(io_flush | _GEN_135) & _GEN_71);
      row_valid_mem_63 <=
        ~_GEN_137
        & (commit_valid
             ? ~((&ROB_output_ROB_index) | io_flush | _GEN_136) & _GEN_72
             : ~(io_flush | _GEN_136) & _GEN_72);
    end
    REG <= _GEN_8 & _ROB_WB_banks_0_io_writeEnableB_T;
    ...
    REG_1 <= _GEN_8 & _ROB_WB_banks_1_io_writeEnableB_T;
    ...
    REG_2 <= _GEN_8 & _ROB_WB_banks_2_io_writeEnableB_T;
    ...
    REG_3 <= _GEN_8 & (&io_FU_outputs_0_bits_fetch_packet_index);
  ...
  assign io_commit_bits_T_NT =
    io_commit_bits_is_misprediction_0 & _GEN_7[earliest_taken_index];
  assign io_commit_bits_ROB_index = ROB_output_ROB_index;
  assign io_commit_bits_br_type =
    io_commit_bits_is_misprediction_0 ? _GEN_6[earliest_taken_index] : 3'h0;
  ...
  assign io_commit_bits_expected_PC =
    io_commit_bits_is_misprediction_0 ? _GEN_5[earliest_taken_index] : expected_PC;
  ...
  assign io_partial_commit_ROB_index_0_valid =
    _commit_row_complete_0_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_ROB_index_0_bits = ROB_output_ROB_index;
  assign io_partial_commit_ROB_index_1_valid =
    _commit_row_complete_1_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_ROB_index_1_bits = ROB_output_ROB_index;
  assign io_partial_commit_ROB_index_2_valid =
    _commit_row_complete_2_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_ROB_index_2_bits = ROB_output_ROB_index;
  assign io_partial_commit_ROB_index_3_valid =
    _commit_row_complete_3_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_ROB_index_3_bits = ROB_output_ROB_index;
  assign io_partial_commit_MOB_index_0_valid =
    _commit_row_complete_0_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_MOB_index_0_bits = ROB_output_ROB_entries_0_MOB_index;
  assign io_partial_commit_MOB_index_1_valid =
    _commit_row_complete_1_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_MOB_index_1_bits = ROB_output_ROB_entries_1_MOB_index;
  assign io_partial_commit_MOB_index_2_valid =
    _commit_row_complete_2_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_MOB_index_2_bits = ROB_output_ROB_entries_2_MOB_index;
  assign io_partial_commit_MOB_index_3_valid =
    _commit_row_complete_3_T & ROB_output_row_valid & ~io_commit_bits_is_misprediction_0;
  assign io_partial_commit_MOB_index_3_bits = ROB_output_ROB_entries_3_MOB_index;
