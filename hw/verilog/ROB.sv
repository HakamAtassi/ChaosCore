...
module ROB(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      ...
      _instruction_PC_T_1 = io_commit_bits_REG_fetch_PC + 32'h2;
      _instruction_PC_T_2 = io_commit_bits_REG_fetch_PC + 32'h4;
      _instruction_PC_T_3 = io_commit_bits_REG_fetch_PC + 32'h6;
