...
module hash_BTB(
  ...
  always @(posedge clock)
    io_BTB_valid_REG <= io_predict_PC[31:17];
  ...
  assign io_BTB_valid =
    io_BTB_valid_REG == _BTB_memory_io_data_out[50:36] & _BTB_memory_io_data_out[51];
...
module BP(
  ...
  input         io_RAS_update_call,
                io_RAS_update_ret,
  output [3:0]  io_RAS_update_NEXT,
                io_RAS_update_TOS,
  output [31:0] io_RAS_update_ret_addr,
  input         io_revert_valid,
                io_revert_GHR,
                io_prediction_ready,
  ...
  RAS RAS (
    ...
    .io_ret_addr     (io_RAS_update_ret_addr),
    .io_NEXT         (_RAS_io_NEXT),
    .io_TOS          (_RAS_io_TOS)
  );
  assign io_predict_ready = io_prediction_ready;
  assign io_RAS_update_NEXT = _RAS_io_NEXT[3:0];
  assign io_RAS_update_TOS = _RAS_io_TOS[3:0];
