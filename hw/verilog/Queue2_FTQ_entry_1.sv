...
module Queue2_FTQ_entry_1(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  wire         do_enq =
    ~(empty & io_deq_ready) & ~(ptr_match & maybe_full) & io_enq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, :259:27, :260:33, :261:25, :262:24, :263:27, :286:19, :298:17, :301:{26,35}
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    if (reset) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
      ...
      wrap <= ~io_flush & (do_enq ? wrap - 1'h1 : wrap);	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:{15,24}, :98:11, src/main/scala/chisel3/util/Decoupled.scala:51:35, :263:27, :269:16, :279:15, :298:17, :301:{26,35}
      wrap_1 <= ~io_flush & (do_deq ? wrap_1 - 1'h1 : wrap_1);	// src/main/scala/chisel3/util/Counter.scala:61:40, :77:{15,24}, :98:11, src/main/scala/chisel3/util/Decoupled.scala:51:35, :264:27, :269:16, :273:16, :279:15, :298:17, :300:14
      maybe_full <= ~io_flush & (do_enq == do_deq ? maybe_full : do_enq);	// src/main/scala/chisel3/util/Counter.scala:98:11, src/main/scala/chisel3/util/Decoupled.scala:51:35, :259:27, :263:27, :264:27, :269:16, :276:{15,27}, :277:16, :279:15, :282:16, :298:17, :300:14, :301:{26,35}
    end
  end // always @(posedge)
  ...
  assign io_deq_bits_valid = empty ? io_enq_bits_valid : _ram_ext_R0_data[0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_fetch_PC = empty ? io_enq_bits_fetch_PC : _ram_ext_R0_data[32:1];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_is_misprediction =
    empty ? io_enq_bits_is_misprediction : _ram_ext_R0_data[33];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_predicted_PC =
    empty ? io_enq_bits_predicted_PC : _ram_ext_R0_data[65:34];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_T_NT = empty ? io_enq_bits_T_NT : _ram_ext_R0_data[66];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_br_type = empty ? io_enq_bits_br_type : _ram_ext_R0_data[69:67];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_GHR = empty ? io_enq_bits_GHR : _ram_ext_R0_data[85:70];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_NEXT = empty ? io_enq_bits_NEXT : _ram_ext_R0_data[92:86];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_TOS = empty ? io_enq_bits_TOS : _ram_ext_R0_data[99:93];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_dominant_index =
    empty ? io_enq_bits_dominant_index : _ram_ext_R0_data[101:100];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_resolved_PC =
    empty ? io_enq_bits_resolved_PC : _ram_ext_R0_data[133:102];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
endmodule
