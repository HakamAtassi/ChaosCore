...
module SDPReadWriteSmem_1(	// src/main/scala/memories/memories.scala:83:7
  input        clock,	// src/main/scala/memories/memories.scala:83:7
               reset,	// src/main/scala/memories/memories.scala:83:7
  input  [5:0] io_rd_addr,	// src/main/scala/memories/memories.scala:84:14
  output [1:0] io_data_out,	// src/main/scala/memories/memories.scala:84:14
  input  [5:0] io_wr_addr,	// src/main/scala/memories/memories.scala:84:14
  input        io_wr_en,	// src/main/scala/memories/memories.scala:84:14
  input  [1:0] io_data_in	// src/main/scala/memories/memories.scala:84:14
);

  wire [1:0] _mem_ext_R0_data;	// src/main/scala/memories/memories.scala:97:24
  reg        hazard_reg;	// src/main/scala/memories/memories.scala:104:27
  reg  [1:0] din_buff;	// src/main/scala/memories/memories.scala:105:25
  always @(posedge clock) begin	// src/main/scala/memories/memories.scala:83:7
    if (reset) begin	// src/main/scala/memories/memories.scala:83:7
      ...
      din_buff <= 2'h0;	// src/main/scala/memories/memories.scala:105:25
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/memories/memories.scala:83:7
    ...
    initial begin	// src/main/scala/memories/memories.scala:83:7
      automatic logic [31:0] _RANDOM[0:0];	// src/main/scala/memories/memories.scala:83:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/memories/memories.scala:83:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// src/main/scala/memories/memories.scala:83:7
        hazard_reg = _RANDOM[/*Zero width*/ 1'b0][0];	// src/main/scala/memories/memories.scala:83:7, :104:27
        din_buff = _RANDOM[/*Zero width*/ 1'b0][2:1];	// src/main/scala/memories/memories.scala:83:7, :104:27, :105:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  mem_64x2_0 mem_ext (	// src/main/scala/memories/memories.scala:97:24
    .R0_addr (io_rd_addr),
