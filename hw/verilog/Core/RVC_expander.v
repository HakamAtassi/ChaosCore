...
module RVC_expander(
  ...
  wire        _GEN_7 =
    CR | LWSP | LI | LUI | ADDI | ADDI16SP | SLLI | CA | _CB_T | SRLI | SRAI | ANDI;
  assign decoded_instr_rs1 =
    _GEN_7 | _GEN_0 ? io_compressed_instr_bits_instruction[11:7] : 5'h0;
  wire        _GEN_8 = _rd_rs2_T | SW | CA;
  assign decoded_instr_rs2 = _GEN_8 ? rd_rs2 : 5'h0;
  assign decoded_instr_rd =
    _GEN_8 | ~(ADDI4SPN | LW)
      ? (_GEN_7 ? io_compressed_instr_bits_instruction[11:7] : 5'h0)
      : rd_rs2;
