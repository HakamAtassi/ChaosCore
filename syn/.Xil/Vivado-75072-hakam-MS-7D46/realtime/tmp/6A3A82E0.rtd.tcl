...
set genomeRtd $env(RT_TMP)/6A3A82E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ChaosCore_tile__GC0}]"
...
set genomeName [subst -nocommands -novariables {ChaosCore_tile__GC0}]
