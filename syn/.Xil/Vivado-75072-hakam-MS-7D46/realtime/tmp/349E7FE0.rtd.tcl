...
set genomeRtd $env(RT_TMP)/349E7FE0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mem_64x32__GB0}]"
...
set genomeName [subst -nocommands -novariables {mem_64x32__GB0}]
